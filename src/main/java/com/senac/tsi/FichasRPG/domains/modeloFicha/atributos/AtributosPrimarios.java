package com.senac.tsi.FichasRPG.domains.modeloFicha.atributos;
...
public class AtributosPrimarios {
    ...
    public AtributosPrimarios(int forca, int constituicao, int tamanho, int destreza,
                              int aparencia, int inteligencia, int poder, int educacao) {
        setForca(forca);
    ...
    public int hashCode() {
        return Objects.hash(forca,constituicao,tamanho,destreza,
                aparencia,inteligencia,poder,educacao);
    }
    ...
    public String toString(){
        return """
                ...
                """.formatted(forca,constituicao,tamanho,destreza,aparencia,inteligencia,
                poder,educacao);
    }
}
