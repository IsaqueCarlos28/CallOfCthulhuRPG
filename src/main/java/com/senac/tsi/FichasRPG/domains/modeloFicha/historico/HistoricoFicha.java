...
public class HistoricoFicha {
    ...
    public HistoricoFicha(ModeloFicha modeloFicha, String descricaoPessoais, String ideologias, Set<Pessoa> pessoasImportantes,
    ...
    public ModeloFicha getFicha() {
        return modeloFicha;
    }
    public void setFicha(ModeloFicha modeloFicha) {
